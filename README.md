...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-18 16:23`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d55a63e2-6cf6-4fb4-95c7-cde58f135a3a.git
$ cd d55a63e2-6cf6-4fb4-95c7-cde58f135a3a
```
